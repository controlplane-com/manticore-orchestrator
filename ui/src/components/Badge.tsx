interface BadgeProps {
  ...
  variant?: 'success' | 'warning' | 'error' | 'info' | 'default' | 'orange' | 'cyan' | 'purple' | 'muted';
  size?: 'sm' | 'md';
  className?: string;
}
...
export const Badge = ({ children, variant = 'default', size = 'md', className }: BadgeProps) => {
  const variantClasses = {
    ...
    purple: 'bg-purple-100 dark:bg-purple-950 text-purple-800 dark:text-purple-300 border border-transparent dark:border-purple-500',
